...
<head>
    ...
    <!-- WEBSITE LOGO -->
    <link rel="icon" href="Imgs/LOGOO_cropped.png">
    <!-- ICONS LINK -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
    <!-- CSS LINK -->
    <link rel="stylesheet" href="./CSS/ADhospital.css">
    ...
    <div class="main close-nav" id="mainDiv">
        ...
        <div class="head">
            ...
            <table id="example" class="table table-striped" style="width:100%">
              ...
              <tr>
              <td><?php echo $key['hospital_name']; ?></td>
              ...
              <td><a href="hospitalform.php?edit=<?php echo $key['hospital_id']; ?>"  class="two" >Edit</a></td>
              <td><a href="ADhospital.php?delete=<?php echo $key['hospital_id']; ?>" class="one">Delete</a></td>
                    </tr>
                    <?php 
             } ?> 
                    <!-- ROW ENDS -->
        ...
        <div class="add">
           <a href="hospitalform.php"> <button>
                Add
            </button></a>
        </div>
        ...
        <!-- JAVA MAIN -->
        <script src="./java/ADhospital.js"></script>
</body>
